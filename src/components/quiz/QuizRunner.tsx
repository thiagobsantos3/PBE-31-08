...
export function QuizRunner({ 
  ...
  const handleCorrect = async () => {
    ...
    const newTotalPoints = session.total_points + currentQuestion.points;
  ...
  const handlePartialPoints = async () => {
    ...
    // Log to database (partial points = not fully correct)
    await logQuestionResult(
      currentQuestion.id,
      partialPoints,
      currentQuestion.points,
    ...
    const newResults = [...session.results, result];
    const newTotalPoints = session.total_points + partialPoints;
